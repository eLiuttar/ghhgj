...
const CHATS = {
  reuniao: {
    name: "Reunião",
    sub: "Alan, Eloísa, Eu, Edgar, Victor",
    avatarClass: "avatar-group",
    avatarImage: "img/unnamed.png",
    isGroup: true,
    lastTime: "18:34",
    messages: [
  ...
  alan: {
    ...
    avatarClass: "avatar-1",
    avatarImage: "img/Logo_Daa-2.png",
    lastTime: "12:59",
    messages: [
      { type: "date", text: "Hoje" },
  ...
  victor: {
    ...
    avatarImage: "img/dia-do-professor.jpg",
    lastTime: "16:45",
    messages: [
      { type: "date", text: "Hoje" },
  ...
  despedidas: {
    ...
    sub: "~ Silvio, +55 11 1234-4013, Clara, Isad.. ",
    avatarClass: "avatar-group",
    avatarImage: "img/unnamed.png",
    isGroup: true,
    lastTime: "18:34",
    messages: [
      { type: "date", text: "13 de abril de 2022" },
      { type: "date", text: "Eloísa saiu" },
      { type: "date", text: "Alan saiu" },
      { type: "date", text: "02 de maio de 2022" },
      { type: "date", text: "Edgar saiu" },
      { type: "date", text: "Victor saiu" },
      { type: "date", text: "14 de junho de 2022" },
      { type: "date", text: "Você saiu" },
    ]
  },
...
function renderChatList() {
  ...
  Object.keys(CHATS).forEach((key) => {
    ...
    item.innerHTML = `
      <div class="contact-avatar ${chat.avatarClass}">
...
function openChat(key) {
  ...
  document.getElementById("chatHeaderAvatar").innerHTML = `<img src="${chat.avatarImage}" alt="${chat.name}">`;
